...
<section>
    <div class="lzy-service-box">
        <div class="lzy-container">
            <!-- search -->
            <div class="user-notice" style="background-color: white;">首页 &nbsp;>&nbsp;公告信息</div>
            <!-- search -->
            <div class="lzy-subst lzy-box-bor" style="margin-top: 20px;">
                <div class="lzy-box-li">
                    ...
                    <c:forEach items="${list}" var="notice">
                        <li class="clearfix">
                            <div class="lzy-nubbin-box"><img src="/getajobssm/upload/${notice.filename }" width="144" height="96" title=""></div>
                            <div class="lzy-nubbin-tex" style="border:0px solid red;padding-top: 5px;">
                                <h2><a href="lookNotice.do?id=${notice.id}">${notice.title}</a></h2>
                                <div class='count'>
                                  <ul>
                                    <li> 
                                      <label class="title">发布时间:</label>${notice.savetime}
                                    </li>
                                  </ul>

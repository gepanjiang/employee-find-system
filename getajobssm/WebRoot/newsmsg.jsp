...
<section>
    <div class="lzy-service-box">
        <div class="lzy-container">
            <!-- search -->
            <div class="user-notice" style="background-color: white;">首页 &nbsp;>&nbsp;新闻信息</div>
            <!-- search -->
            <div class="lzy-subst lzy-box-bor" style="margin-top: 20px;">
                <div class="lzy-box-li">
                    ...
                    <c:forEach items="${list}" var="news">
                        <li class="clearfix">
                            <div class="lzy-nubbin-box"><img src="/getajobssm/upload/${news.filename }" width="144" height="96" title=""></div>
                            <div class="lzy-nubbin-tex" style="border:0px solid red;padding-top: 5px;">
                                <h2><a href="lookNews.do?id=${news.id}">${news.title}</a></h2>
                                <div class='count'>
                                  <ul>
                                    <li> 
                                      <label class="title">发布时间:</label>${news.savetime}
                                    </li>
                                  </ul>
                    ...
                    <a href="javascript:void(0)" style="font-family:楷体;">共${total}条记录&nbsp;&nbsp;&nbsp;&nbsp;第${index}/${pages}页</a>&nbsp;&nbsp;
                     ...
                     <a href="newsMsg.do?index=1&key=${key}" style="font-family:楷体;">首页</a>&nbsp;&nbsp;
                     
                     <c:choose>
                     <c:when test="${index >1}">
                     <a href="newsMsg.do?index=${index-1}&key=${key}" style="font-family:楷体;">上一页</a>
                     </c:when>
                     <c:otherwise>
                     ...
                     <a href="newsMsg.do?index=${index+1}&key=${key}" style="font-family:楷体;">下一页</a>
                     </c:when>
                     <c:otherwise>
                     ...
                     &nbsp;&nbsp;
                     <a href="newsMsg.do?index=${pages}&key=${key}" style="font-family:楷体;">末页</a>

			    ...
			    $("#btnDelete").click(function(){
			        ...
			        $(".check:checked").each(function(index,a){
						...
						$.dialog.confirm("你确定要删除吗?", function(){
				             window.location.href=encodeURI('newsDel.do?idlist='+ idlist);
						  });
					});
...
<body>
           ...
           <div class="search-title">
                ...
                <div class="description">
                    <a href="/getajobssm/admin/newsadd.jsp">新增新闻</a>
                </div>
            </div>
            
               <div class="search-options">
               <form id="searchForm" action="newsList.do" method="post">
            ...
            <table id="module" width="100%" border="0" cellspacing="0"
						  ...
						  <c:otherwise>
						   <c:forEach items="${list}" var="news">
								<tr>
									...
									<td>
										<a class="edit" href="showNews.do?id=${news.id}">修改</a>
									</td>
								</tr>
							 </c:forEach>
							</c:otherwise>
					...
					<td align="center" style="font-weight: bold;font-family:楷体;font-weight: bold; color:blue" colspan="10">
                     ...
                     <a href="newsList.do?index=1&key=${key}" style="font-family:楷体;">首页</a>&nbsp;&nbsp;
                     
                     <c:choose>
                     <c:when test="${index >1}">
                     <a href="newsList.do?index=${index-1}&key=${key}" style="font-family:楷体;">上一页</a>
                     </c:when>
                     <c:otherwise>
                     ...
                     <a href="newsList.do?index=${index+1}&key=${key}" style="font-family:楷体;">下一页</a>
                     </c:when>
                     <c:otherwise>
                     ...
                     &nbsp;&nbsp;
                     <a href="newsList.do?index=${pages}&key=${key}" style="font-family:楷体;">末页</a>
                 </td>
...
%>
layer.msg('<%=suc%>');
window.setTimeout(function(){location.replace('/getajobssm/admin/newslist.jsp');},3000); 
<%}%>
</script>
</html>
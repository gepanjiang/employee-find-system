    ...
    <div class="user-content">
        <div class="user-boxes-bk">
            <div class="user-boxes-ma" >
                <div class="user-notice user-notice-cl"><h3>新闻详情</h3></div>
                <div class="user-present" style="border:0px solid red">
                    <div class="workimg">
                     <img alt="" src="/getajobssm/upload/${news.filename}">
                   </div>
                   <div class="workpro">
                    <ul>
                       <li style="background-image: url('');font-size:24px;color: #F39800;font-family: '微软雅黑'">${news.title}</li>
                       <li style="background-image: url('');height: 20px;"></li>
                       <li style="background-image: url('');"><label>发布时间:</label>${news.savetime}</li>
                    </ul>
                   </div>

           ...
           <div class="user-boxes-ma">
               ...
               <div class="user-present" >
                   <ul >
                       ...
                       <label style="font-weight: bold;letter-spacing: 2px;">真实姓名:</label><span style="margin-left: 2px;">${member.tname}</span>
                       </li>
                       <li style="background-image: url('');float: left;border:0px solid red;width: 260px;height: 40px;line-height:40px;">
                       <label style="font-weight: bold;letter-spacing: 2px;">年龄:</label><span style="margin-left: 2px;">${member.age}</span>
                       </li>
                       <li style="background-image: url('');float: left;border:0px solid red;width: 260px;height: 40px;line-height:40px;">
                       <label style="font-weight: bold;letter-spacing: 2px;">联系电话:</label><span style="margin-left: 2px;">${member.tel}</span>
                       </li>
                       <li style="background-image: url('');float: left;border:0px solid red;width: 260px;height: 40px;line-height:40px;">
                       <label style="font-weight: bold;letter-spacing: 2px;">地址:</label><span style="margin-left: 2px;">${member.addr}</span>
                       </li>
                       <li style="background-image: url('');float: left;border:0px solid red;width: 260px;height: 40px;line-height:40px;">
                       <label style="font-weight: bold;letter-spacing: 2px;">专业:</label><span style="margin-left: 2px;">${member.major}</span>
                       </li>
                       <li style="background-image: url('');float: left;border:0px solid red;height: 40px;line-height:40px;">
                       <label style="font-weight: bold;letter-spacing: 2px;">求职意向:</label><span style="margin-left: 2px;">${member.ziwei}</span>
                       </li>
                   </ul>
